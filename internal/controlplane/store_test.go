...
func TestStoreDeletingTriggeredJobPreservesPendingReconciliation(t *testing.T) {
	...
	admission := TriggerAdmission{
		...
		OccurrenceKey: "github.com/event/1", Subject: "https://github.com/mitkox/esf/issues/396", ScheduledAt: time.Now().UTC(),
		Prompt: "Complete issue", Repository: "machinist", SelectionName: "foreman", Command: testAgent("foreman", "Complete issue"),
		GitHubRepository: "mitkox/esf", GitHubIssueNumber: 396, RequestActor: "owner", RequestLabel: "machinist:requested",
	}
...
func TestStoreRetriesUncommittedAdmissionAndPreventsSubjectOverlap(t *testing.T) {
	...
	admission := TriggerAdmission{Identity: "github/intake", Family: "github", ConfigSignature: "v1", ConfigGeneration: mustTriggerGeneration(t, store, "github/intake"), OccurrenceKey: "github.com/event/1", Subject: "https://github.com/mitkox/esf/issues/396", Prompt: "Complete issue", Repository: "machinist", SelectionName: "foreman", GitHubRepository: "mitkox/esf", GitHubIssueNumber: 396, RequestActor: "owner", RequestLabel: "machinist:requested", ScheduledAt: time.Now().UTC()}
