...
func TestManagedGitHubTriggerCommitsBeforeLabelsAndRepairsWithoutDuplicate(t *testing.T) {
	...
	client := &fakeGitHubTriggerClient{
		candidates: []GitHubCandidate{{Repository: "mitkox/esf", Number: 396, URL: "https://github.com/mitkox/esf/issues/396", State: "open", CreatedAt: clock}},
		details:    GitHubIssueDetails{GitHubCandidate: GitHubCandidate{Repository: "mitkox/esf", Number: 396, Title: "Make cards readable", URL: "https://github.com/mitkox/esf/issues/396", State: "open", CreatedAt: clock}, Labels: []string{"machinist:requested"}, RequestedEvent: event},
...
func TestManagedGitHubTriggerFinishesAdmittedLabelRepairAfterRepositoryRemoval(t *testing.T) {
	...
	candidate := GitHubCandidate{Repository: "mitkox/esf", Number: 396, State: "open", CreatedAt: clock}
	client := &fakeGitHubTriggerClient{
...
func TestManagedGitHubTriggerRejectsUnauthorizedActor(t *testing.T) {
	...
	client := &fakeGitHubTriggerClient{
		candidates: []GitHubCandidate{{Repository: "mitkox/esf", Number: 396, State: "open", CreatedAt: clock}},
		details:    GitHubIssueDetails{GitHubCandidate: GitHubCandidate{Repository: "mitkox/esf", Number: 396, State: "open", CreatedAt: clock}, Labels: []string{"machinist:requested"}, RequestedEvent: &GitHubLabelEvent{ID: "123", Actor: "reader", CreatedAt: clock, OccurrenceKey: "github.com:123"}},
		permission: "read",
	}
	server := &Server{store: store, triggers: []config.ResolvedTrigger{trigger}, github: client, now: func() time.Time { return clock }}
	if err := processManagedTriggers(t.Context(), server); err != nil {
...
func TestManagedGitHubTriggerConsumesUnauthorizedCandidatesBeyondSearchWindow(t *testing.T) {
	...
	for number := 1; number <= maxGitHubCandidates+1; number++ {
		...
		candidate := GitHubCandidate{Repository: "mitkox/esf", Number: number, State: "open", CreatedAt: clock.Add(time.Duration(number) * time.Second)}
...
func TestManagedGitHubTriggerAdmitsAuthorizedWorkflowTokenActor(t *testing.T) {
	...
	client := &fakeGitHubTriggerClient{
		candidates: []GitHubCandidate{{Repository: "mitkox/esf", Number: 396, State: "open", CreatedAt: clock}},
		details: GitHubIssueDetails{
			GitHubCandidate: GitHubCandidate{Repository: "mitkox/esf", Number: 396, State: "open", CreatedAt: clock},
...
func githubTestTrigger() config.ResolvedTrigger {
	return config.ResolvedTrigger{
		...
		GitHubRepositories: map[string]string{"machinist": "mitkox/esf"},
