...
```sh
mkdir -p ~/Code/github/mitkox
git clone git@github.com:mitkox/esf.git \
  ~/Code/github/mitkox/esf
```

Confirm Git can access the repository:

```sh
git -C ~/Code/github/mitkox/esf remote -v
git -C ~/Code/github/mitkox/esf fetch --dry-run
```
